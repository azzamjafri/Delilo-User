...
class WomenFashionCategory extends StatefulWidget {
  String category;
  WomenFashionCategory(String param) {
    category = param;
  }
  @override
  _WomenFashionCategoryState createState() => _WomenFashionCategoryState();
}

class _WomenFashionCategoryState extends State<WomenFashionCategory> {
  @override
