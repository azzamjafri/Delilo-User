...
class KidsFashionCategory extends StatefulWidget {
  String type;
  KidsFashionCategory(String type) {
    this.type = type;
  }

  @override
  _KidsFashionCategoryState createState() => _KidsFashionCategoryState();
}

class _KidsFashionCategoryState extends State<KidsFashionCategory> {
  @override
